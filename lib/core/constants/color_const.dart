...
class ColorConst {
  ...
  static Color hintColor = const Color(0xFFF8F8F8);
  ...
  static const Color greenActiveColor = Color(0xff28A503);
  ...
  // static const Color textBlueColor = Colors.white;
  static const Color closeRedColor = Color(0xffd14141);

  // static const Color signInModeButtonColor = Color(0xFFEDEDED);
  static const Color signInModeButtonColor = Color(0xFFF8F8F8);

  // static const Color signInModeButtonColor = Color(0xFFFBFBFB);
